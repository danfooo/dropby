...
**What it is not:**
- Not a scheduling tool (no calendars, no confirmations, no reminders to the recipient)
- Not a mass social network (small, trusted circles only)
- Not a messaging app (no chat, no threads, no replies)
- Not formal, not corporate, not urgent

**Personality:**
- Warm but not cutesy
- Simple but not cold
- Spontaneous but not chaotic
- Human-scale — this is about a handful of close people, not followers

**Reference feeling:** The moment someone texts "I'm around if you want to come by" — casual, low-stakes, genuinely open. The app should feel like that message.
...
- **Warmth** — the light spilling out of an open door at dusk
- **Threshold** — something you cross voluntarily, never pushed through
- **Impermanence** — the door is open *now*, not forever
- **Intimacy** — you only open your door to people you know

The door is already in the product copy ("open your door", "your door is open"). The visual identity should reinforce this without being literal about it.
...
**Tone:**
- First name only, never formal address
- Contractions always ("you're", not "you are")
- Short sentences. Fragments are fine.
- No exclamation marks except in genuinely exciting moments (and even then, once)
...
**Wrong tone:**
- "Your availability status has been set to Active!"
- "Connect with friends and let them know you're available for a spontaneous visit."
- "Reminder: You opened your door at this time last week."

**Emoji use:** One per message, at most. Used to add warmth, not emphasis. The door 🚪, the wave 👋, the heart 🫶 are all on-brand. Avoid anything that reads as hype (🚀🔥💯).
