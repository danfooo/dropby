...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    // MARK: - Remote notification registration (forward to Capacitor)
    ...
    // URL and activity opens arrive in SceneDelegate under the scene lifecycle;
    // these stay so Capacitor's proxy keeps its hook, as in the stock template.
