  ...
  return (
    <div className="min-h-full flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Drop By</h1>
        <p className="text-xl text-gray-500 max-w-xs leading-relaxed">
          One tap tells your friends you're open to a spontaneous visit.
        </p>
        <p className="mt-2 text-gray-400">No plans. No group chats. Just "swing by."</p>
      </div>

      {/* How it works */}
      <div className="px-6 pb-8">
        <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-widest text-center mb-6">How it works</h2>
